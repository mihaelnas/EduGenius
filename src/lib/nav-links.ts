...
import { LayoutDashboard, Users, School, Book, Calendar, User, BookOpen, ShieldCheck } from 'lucide-react';
...
export const adminNavLinks: NavLink[] = [
  ...
  { href: '/dashboard/admin/authorized-students', label: 'Liste d\'Admission', icon: ShieldCheck },
];
