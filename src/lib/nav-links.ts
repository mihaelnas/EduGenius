...
import { LayoutDashboard, Users, School, Book, Calendar, User, BookOpen, AlertTriangle } from 'lucide-react';
...
export const adminNavLinks: NavLink[] = [
  ...
  { href: '/dashboard/admin/permission-tests', label: 'Tests de Droits', icon: AlertTriangle },
];
